	...
	<div className="space-y-3 fixed w-60  h-screen">
		...
		<div className="flex-1">
			<ul className="pt-2 pb-4 space-y-1 text-sm">
				...
				<li className="rounded-sm hover:bg-neutral-900">
					<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/20/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
				...
				<li className="rounded-sm hover:bg-neutral-900 dark:bg-gray-800 dark:text-gray-50">
					<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
